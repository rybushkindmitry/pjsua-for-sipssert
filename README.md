...
### Сценарий 4: Тестирование SBC/Proxy (сквозной)
...
|---|---|---|
| `--mode` | `uac`, `uas`, `uas-tls-client` | `uac` |
...
### Echo-валидация (режим uas-tls-client)
...
```
.
├── Dockerfile              # Multi-stage: сборка PJSIP + runtime-образ
